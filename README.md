...
| 🅿️ 코딩 기초 트레이닝 | 55      | 공배수, 접미사인지 확인하기, 이어 붙인 수, 외계행성의 나이, 피자 나눠 먹기 (2) 등 |
...
| 🅱️ 수학 1       | 3      | 진법 변환, 진법 변환 2, 세탁소 시장 동혁  |
| **🧮 총합**              | **191** |                                                                                             |
...
| 유형               | 문제 수 | 예시 문제명                                                           |
|-------------------|--------|------------------------------------------------------------------------|
| 🅿️ SELECT          | 33  | 아픈 동물 찾기, 조건에 맞는 회원수 구하기, 흉부외과 또는 일반외과 의사 목록 출력하기 등 |
| 🅿️ GROUP BY        | 24  | 동명 동물 수 찾기, 고양이와 개는 몇 마리 있을까, 입양 시각 구하기(1) 등           |
| 🅿️ JOIN            | 11      | 조건에 맞는 도서와 저자 리스트 출력하기, 오랜 기간 보호한 동물(1), 있었는데요 없었습니다 등 |
...
- ✅ Python 문제 풀이: **191문제 완료 / 목표 500문제**
- ✅ SQL 문제 풀이: **116문제 완료 / 목표 200문제**
