...
| 🅿️ 연습 문제 | 63       | 자릿수 더하기, 문자열을 정수로 바꾸기, 최댓값과 최솟값, 숫자의 표 등 |
...
| 🅱️ 반복문     | 14      | 구구단, A+B-3, 합, 영수증, 코딩은 체육과목입니다, 빠른 A+B 등 |
...
| <img width="20" height="20" alt="image" src="https://github.com/user-attachments/assets/9e086ffb-cf13-4764-a923-ba5bd61ed38c"/>  난이도 2 | 22     | 	두 테이블 결합하기, 레스토랑 웨이터의 팁 분석, 일별 블로그 방문자 수 집계 등 |
...
- ✅ Python 문제 풀이: **395문제 완료 / 목표 500문제**
- ✅ SQL 문제 풀이: **172문제 완료 / 목표 200문제**
