...
| 유형                     | 문제 수 | 문제명                                                                                      |
|--------------------------|--------|---------------------------------------------------------------------------------------------|
| 🅿️ 코딩테스트 입문 | 72      | 암호 해독, 인덱스 바꾸기, 약수 구하기, 배열 만들기1, 가장 큰 수 찾기 등 |
| 🅿️ 코딩 기초 트레이닝 | 108      | 공배수, 접미사인지 확인하기, 이어 붙인 수, 외계행성의 나이, 피자 나눠 먹기 (2) 등 |
| 🅿️ 연습 문제 | 22       | 자릿수 더하기, 문자열을 정수로 바꾸기, 최댓값과 최솟값, 숫자의 표 등 |
| 🅿️ 월간 코드 챌린지 | 4       | 나머지가 1이 되는 수 찾기, 음양 더하기, 내적 등 |
...
| <img width="20" height="20" alt="image" src="https://github.com/user-attachments/assets/9e086ffb-cf13-4764-a923-ba5bd61ed38c"/>  난이도 2 | 12     | 	두 테이블 결합하기, 레스토랑 웨이터의 팁 분석, 일별 블로그 방문자 수 집계 등 |
| **총합**           | **156** |                                                                        |
...
- ✅ Python 문제 풀이: **290문제 완료 / 목표 500문제**
- ✅ SQL 문제 풀이: **156문제 완료 / 목표 200문제**
