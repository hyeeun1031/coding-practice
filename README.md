...
| 🅿️ 코딩 기초 트레이닝 | 84      | 공배수, 접미사인지 확인하기, 이어 붙인 수, 외계행성의 나이, 피자 나눠 먹기 (2) 등 |
...
| <img width="20" height="20" alt="image" src="https://github.com/user-attachments/assets/9e086ffb-cf13-4764-a923-ba5bd61ed38c"/>  난이도 1 | 10      | 	모든 데이터 조회하기, 일부 데이터 조회하기, 최근 올림픽이 개최된 도시 등  |
| **총합**           | **138** |                                                                        |
...
- ✅ Python 문제 풀이: **234문제 완료 / 목표 500문제**
- ✅ SQL 문제 풀이: **138문제 완료 / 목표 200문제**
