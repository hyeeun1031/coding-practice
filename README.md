...
| 🅿️ 연습 문제 | 5       | 자릿수 더하기, 문자열을 정수로 바꾸기, 최댓값과 최솟값, 숫자의 표 등 |
...
| <img width="20" height="20" alt="image" src="https://github.com/user-attachments/assets/9e086ffb-cf13-4764-a923-ba5bd61ed38c"/>  난이도 1 | 4      | 	모든 데이터 조회하기, 일부 데이터 조회하기, 최근 올림픽이 개최된 도시 등  |
| **총합**           | **132** |                                                                        |
...
- ✅ Python 문제 풀이: **223문제 완료 / 목표 500문제**
- ✅ SQL 문제 풀이: **132문제 완료 / 목표 200문제**
