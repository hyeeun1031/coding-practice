...
| 🅿️ 코딩 기초 트레이닝 | 80      | 공배수, 접미사인지 확인하기, 이어 붙인 수, 외계행성의 나이, 피자 나눠 먹기 (2) 등 |
| 🅿️ 연습 문제 | 9       | 자릿수 더하기, 문자열을 정수로 바꾸기, 최댓값과 최솟값, 숫자의 표 등 |
...
| 🅱️ 약수, 배수와 소수 1       | 4      | 	배수와 약수, 약수 구하기, 소수 찾기, 약수들의 합  
| **🧮 총합**              | **228** |                                                                                             |
...
| <img width="20" height="20" alt="image" src="https://github.com/user-attachments/assets/9e086ffb-cf13-4764-a923-ba5bd61ed38c"/>  난이도 1 | 7      | 	모든 데이터 조회하기, 일부 데이터 조회하기, 최근 올림픽이 개최된 도시 등  |
| **총합**           | **135** |                                                                        |
...
- ✅ Python 문제 풀이: **228문제 완료 / 목표 500문제**
- ✅ SQL 문제 풀이: **135문제 완료 / 목표 200문제**
