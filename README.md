...
| 유형                     | 문제 수 | 문제명                                                                                      |
|--------------------------|--------|---------------------------------------------------------------------------------------------|
| 🅿️ 코딩테스트 입문 | 70      | 암호 해독, 인덱스 바꾸기, 약수 구하기, 배열 만들기1, 가장 큰 수 찾기 등 |
| 🅿️ 코딩 기초 트레이닝 | 104      | 공배수, 접미사인지 확인하기, 이어 붙인 수, 외계행성의 나이, 피자 나눠 먹기 (2) 등 |
...
| <img width="20" height="20" alt="image" src="https://github.com/user-attachments/assets/9e086ffb-cf13-4764-a923-ba5bd61ed38c"/>  난이도 2 | 9     | 	두 테이블 결합하기, 레스토랑 웨이터의 팁 분석, 일별 블로그 방문자 수 집계 등 |
| **총합**           | **153** |                                                                        |
...
- ✅ Python 문제 풀이: **286문제 완료 / 목표 500문제**
- ✅ SQL 문제 풀이: **153문제 완료 / 목표 200문제**
