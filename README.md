...
| 🅿️ 코딩 기초 트레이닝 | 52      | 공배수, 접미사인지 확인하기, 이어 붙인 수, 외계행성의 나이, 피자 나눠 먹기 (2) 등 |
...
| 유형               | 문제 수 | 예시 문제명                                                           |
|-------------------|--------|------------------------------------------------------------------------|
| 🅿️ SELECT          | 31  | 아픈 동물 찾기, 조건에 맞는 회원수 구하기, 흉부외과 또는 일반외과 의사 목록 출력하기 등 |
...
- ✅ Python 문제 풀이: **185문제 완료 / 목표 500문제**
- ✅ SQL 문제 풀이: **113문제 완료 / 목표 200문제**
