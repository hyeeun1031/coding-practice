...
| 🅿️ 연습 문제 | 46       | 자릿수 더하기, 문자열을 정수로 바꾸기, 최댓값과 최솟값, 숫자의 표 등 |
...
| <img width="20" height="20" alt="image" src="https://github.com/user-attachments/assets/9e086ffb-cf13-4764-a923-ba5bd61ed38c"/>  난이도 3 | 8     | 	복수 국적 메달 수상한 선수 찾기, 할부는 몇 개월로 해드릴까요 등|
| **총합**           | **167** |                                                                        |
...
- ✅ Python 문제 풀이: **371문제 완료 / 목표 500문제**
